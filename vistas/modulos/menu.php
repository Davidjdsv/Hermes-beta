...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="../../index3.html" class="brand-link">
    <img src="vistas\img\hermes-logo.jfif" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
        <img src="vistas\img\usuarios\profile_pic.jfif" class="img-circle elevation-2" alt="User Image" style="width: 35px; height: 35px; object-fit: cover; border-radius: 50%;">
      </div>
      <div class="info">
